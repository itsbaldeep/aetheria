...
func encode() -> PackedByteArray:
	...
	w.write_int64_field(13, mp)
	w.write_int64_field(14, max_mp)
	w.write_int64_field(15, xp)
	w.write_int64_field(16, xp_for_level)
	return w.buf
	...
	while true:
		...
		match f[0]:
			...
			13:
				m.mp = w.read_varint()
			14:
				m.max_mp = w.read_varint()
			15:
				m.xp = w.read_varint()
			16:
				m.xp_for_level = w.read_varint()
			_:
				w.skip(f[1])
